...
batch_sampler.sampling_probs = torch.load('saves/sampler_odin_VA_Both_2.pt')

embeddings_df = make_embeddings(df, art_model, batch_sampler, device)

art_model.load_state_dict(torch.load('saves/model_stsaclf_2.pth'))
...
batch_sampler.sampling_probs = torch.load('saves/sampler_odin_VA_Both_0.pt')
